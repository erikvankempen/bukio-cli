...
[![Tests](https://img.shields.io/badge/tests-391%20passing-brightgreen)](test/report.md)
...
| Human oversight | Every commit is reviewed by the owner before it lands; the automated test suite (391 tests, `npm test`) must pass; money paths additionally require a balanced trial balance. Nothing is accepted blind. |
