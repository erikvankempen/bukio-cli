...
[![Tests](https://img.shields.io/badge/tests-338%20passing-brightgreen)](test/report.md)
...
| 9 | External handover: `export xaf` (Auditfile Financieel 4.0) + audit log as csv/xlsx | The year as a file your boekhouder/tax advisor/auditor imports directly — **✅ done (v0.12.0, 338 tests green)** | planned |
