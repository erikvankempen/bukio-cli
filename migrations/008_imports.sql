-- 008_imports.sql — widen journal_entries.source CHECK to allow machine imports.
-- New sources: 'import' (CSV opening balances / journal import), 'xaf'
-- (XML Auditfile Financieel 4.0 import).
...
CREATE TABLE journal_entries_new (
  ...
  source          TEXT NOT NULL DEFAULT 'manual' CHECK (source IN ('manual','bank','invoice','agent','reversal','recurring','closing','import','xaf')),
  source_ref      TEXT,
